      ...
      <section className="hero">
        ...
        <div className="heroPanel">
          ...
          <ul>
            ...
            <li>Priority invite when the pilot opens</li>
          </ul>
        </div>
      </section>

      <section id="about" className="card"><h2>About the App</h2><p>This pre-launch page introduces the app, builds interest, and helps future members stay connected while the full experience is being prepared.</p></section>

      <section id="how-it-works" className="card">
        <h2>How It Works</h2>
        <div className="steps">
          <div><h3>1. Explore</h3><p>Learn what the app will help you discover and plan.</p></div>
          <div><h3>2. Join Early Access</h3><p>Share your info so we can keep you updated.</p></div>
          <div><h3>3. Get Invited</h3><p>Early members are first in line when the pilot opens.</p></div>
        </div>
      </section>

      <section id="join" className="card"><h2>Join Early Access</h2><p>Be among the first to hear when the app opens for the pilot.</p><EarlyAccessForm /></section>
      <section id="signin" className="card signin"><h2>Member Sign-In</h2><p>Invitation-only during the pilot. Please join early access for updates.</p></section>
