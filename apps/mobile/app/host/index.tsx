...
function Summary({ value, label, meta, icon, tone, onPress, roomy }: { value: string; label: string; meta: string; icon: Parameters<typeof AppIcon>[0]['name']; tone: SummaryTone; onPress: () => void; roomy: boolean }) {
  ...
  return <Pressable style={[styles.summaryCard, { borderColor: `${accent}88`, backgroundColor: background }, roomy && styles.summaryCardRoomy]} onPress={onPress}>
    <View style={styles.summaryTop}><View style={[styles.summaryIcon, { backgroundColor: `${accent}22`, borderColor: `${accent}55` }]}><AppIcon name={icon} color={accent} size={17} /></View><Text style={[styles.summaryArrow, { color: accent }]}>›</Text></View>
    <Text style={styles.summaryValue}>{value}</Text><Text style={styles.summaryLabel}>{label}</Text><Text style={[styles.summaryMeta, { color: accent }]} numberOfLines={1}>{meta}</Text>
  </Pressable>;
}
...
const styles = StyleSheet.create({
  ...
  summaryStrip: { flexDirection: 'row', flexWrap: 'wrap', gap: 9, marginTop: 8 }, summaryStripRoomy: { flexWrap: 'nowrap' }, summaryCard: { width: '48.5%', minHeight: 118, borderRadius: 17, borderWidth: 1, padding: 12 }, summaryCardRoomy: { width: 'auto', flex: 1, minWidth: 145 }, summaryTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }, summaryIcon: { width: 33, height: 33, borderRadius: 17, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, summaryArrow: { fontSize: 22, lineHeight: 24, fontWeight: '700' }, summaryValue: { color: COLORS.cream, fontSize: 23, fontWeight: '900' }, summaryLabel: { color: COLORS.cream, fontSize: 10.5, marginTop: 1 }, summaryMeta: { fontSize: 8.5, marginTop: 8, fontWeight: '700' }, danger: { color: COLORS.danger },
