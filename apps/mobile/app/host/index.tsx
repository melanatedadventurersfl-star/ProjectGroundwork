...
export default function HostOperationsScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      {!loading && !accessLoadFailed && !approved && record ? (() => { const copy = statusCopy[record.status] ?? ['Application status', 'Your hosting application is being reviewed.']; return (
...
const styles=StyleSheet.create({
 ...
 loadingCard:{borderRadius:16,borderWidth:1,borderColor:'#2D3731',backgroundColor:'#151B17',padding:18,alignItems:'center',gap:10},loadingText:{color:'#A8B1AB',fontSize:12,fontWeight:'800'},
 applicationCard:{borderRadius:20,borderWidth:1,borderColor:'#314438',backgroundColor:'#121C16',padding:18},errorCard:{borderRadius:20,borderWidth:1,borderColor:'#684139',backgroundColor:'#211715',padding:18},cardEyebrow:{color:'#D7B45A',fontSize:10,fontWeight:'900',letterSpacing:1},cardTitle:{color:'#FFF8E8',fontSize:23,lineHeight:29,fontWeight:'900',marginTop:7},body:{color:'#AAB4AD',fontSize:14,lineHeight:21,marginTop:8},reviewNote:{color:'#E7C464',fontSize:11,lineHeight:17,marginTop:12},errorDetail:{color:'#BB8F87',fontSize:10.5,lineHeight:16,marginTop:11},
