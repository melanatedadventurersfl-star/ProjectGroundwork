  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content}>
    ...
    {items.map(({ campaign, operations }) => <View key={campaign.id} style={styles.card}>
      ...
      <View style={styles.actions}>
        <Pressable style={styles.secondary} onPress={() => router.push(`/host/manage/${campaign.adventureId}` as never)}><Text style={styles.secondaryText}>Open Event</Text></Pressable>
