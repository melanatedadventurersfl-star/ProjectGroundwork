  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content}>
    ...
    {items.map(({ campaign, operations, duplicateCount }) => <View key={campaign.id} style={styles.card}>
      ...
      <View style={styles.actions}>
        <Pressable style={styles.secondary} onPress={() => router.push(`/host/event-work/${campaign.slug}` as never)}><Text style={styles.secondaryText}>Open Event Work</Text></Pressable>
