  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content}>
    ...
    {profile ? <>
      ...
      <View style={styles.panel}>
        ...
        <Field label="Default cancellation / refund note" value={profile.defaultCancellationNote} onChangeText={(defaultCancellationNote: string) => setProfile({ ...profile, defaultCancellationNote })} placeholder="Optional default note" multiline />
      ...
      <Text style={styles.sectionTitle}>Event creation</Text>
      <View style={styles.panel}>
        <Text style={styles.panelTitle}>Event Builder</Text>
        <Text style={styles.panelCopy}>Set your organization’s event types, tags, labels, conditional difficulty, and starting defaults.</Text>
        <Pressable style={styles.secondary} onPress={() => router.push('/host/event-builder-settings' as never)}><Text style={styles.secondaryText}>Configure Event Builder</Text></Pressable>
      </View>
