...
const options = [
  { title: 'Start Blank', body: 'Create the event foundation, then add the components this event needs.', route: '/host/create-scratch', icon: '＋' },
...
export default function HostCreateChooserScreen() {
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content}>
    ...
    <Text style={styles.subtitle}>Start with the foundation, then build the event from tickets, food, vendors, communications, teams, finance and the other pieces it needs.</Text>
