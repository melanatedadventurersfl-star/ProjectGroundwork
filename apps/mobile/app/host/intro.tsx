...
export default function HostIntroductionScreen() {
  ...
  return <SafeAreaView style={styles.safe}>
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <View style={styles.topRow}><View><Text style={styles.brand}>{profile?.organizationName.toUpperCase() ?? 'ORGANIZATION WORKSPACE'}</Text><Text style={styles.context}>HOST CENTER INTRO</Text></View><Pressable disabled={working} onPress={() => void skipIntro()}><Text style={styles.skip}>Skip intro</Text></Pressable></View>
