...
const styles = StyleSheet.create({
  ...
  photoActionTitle: { color: '#F5F2E8', fontWeight: '800', fontSize: 14 },
  ...
  personCopy: { flex: 1 },
  personName: { color: '#F2F0E8', fontWeight: '800', fontSize: 14 },
  ...
  visibilityTitle: { color: '#BEC7C2', fontWeight: '800', fontSize: 14 },
  ...
  saveButtonText: { color: '#17211C', fontWeight: '900', letterSpacing: 0.7 },
