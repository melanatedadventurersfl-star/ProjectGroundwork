...
export default function TenantMenuScreen() {
  ...
  return <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    ...
    <View style={[styles.separationCard, { borderColor: `${accent}50` }]}>
      ...
      <View style={styles.flex}><Text style={[styles.separationTitle, { color: text }]}>Private organization experience</Text><Text style={styles.separationText}>{brandName} keeps its profile, community, membership, and saved-content data inside this organization experience.</Text></View>
    </View>
