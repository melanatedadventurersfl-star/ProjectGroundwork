...
const styles = StyleSheet.create({
  ...
  title: { color: '#F6F3EA', fontSize: 23, lineHeight: 27, fontWeight: '900' },
  ...
  statusText: { color: '#17211C', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  statusPreviewText: { color: '#A3ADA7' },
  statusDot: { color: '#69756E' },
  collection: { color: '#55D4E0', fontSize: 11, fontWeight: '900', letterSpacing: 1 },
  ...
  eyebrow: { color: '#55D4E0', fontSize: 11, fontWeight: '900', letterSpacing: 1.1 },
  sectionTitle: { color: '#F3F0E7', fontSize: 20, fontWeight: '900', marginTop: 3 },
  ...
  outlineButtonText: { color: '#F5C341', fontSize: 11, fontWeight: '900' },
  ...
  visibilityPillText: { color: '#67CFC8', fontSize: 9, fontWeight: '900', letterSpacing: 0.7 },
  publicText: { color: '#7BC987' },
  memoryTitle: { color: '#F4F1E8', fontSize: 18, lineHeight: 22, fontWeight: '900' },
  memoryBody: { color: '#C0C8C3', fontSize: 14, lineHeight: 20 },
  tagsLine: { flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: 3 },
  tagsLabel: { color: '#87948D', fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  ...
  avatarFallbackText: { color: '#F5C341', fontWeight: '900' },
  ...
  pendingBadgeText: { color: '#F5C341', fontSize: 8, fontWeight: '900' },
  ...
  connectionButtonText: { color: '#17211C', fontSize: 10, fontWeight: '900' },
