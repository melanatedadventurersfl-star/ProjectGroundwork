...
export default function ProfileScreen(){
 ...
 return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
  ...
  <View style={styles.rankCard}>
   <View style={styles.rankIcon}><RankEmblem rank={rank} size={64}/></View>
...
const styles=StyleSheet.create({
 safe:{flex:1,backgroundColor:'#09110F'},center:{flex:1,backgroundColor:'#09110F',alignItems:'center',justifyContent:'center'},content:{paddingHorizontal:18,paddingTop:8,paddingBottom:108,gap:14},editContent:{padding:20,paddingBottom:160,gap:14},pressed:{opacity:.58},
 ...
 rankCard:{backgroundColor:'#111A17',borderWidth:1,borderColor:'#32443A',borderRadius:20,paddingHorizontal:14,paddingVertical:11,flexDirection:'row',alignItems:'center',gap:11},rankIcon:{width:72,alignItems:'center',justifyContent:'center'},rankCopy:{flex:1,minWidth:0},rankName:{color:'#F7F8F3',fontSize:17,fontWeight:'900',letterSpacing:.5},rankSubtitle:{color:'#67CFC8',fontSize:11.5,fontWeight:'800',marginTop:2},rankAdventureCount:{color:'#D4DBD7',fontSize:13,fontWeight:'800',marginTop:5},progressTrack:{height:5,borderRadius:99,backgroundColor:'#194B4B',overflow:'hidden',marginTop:8},progressFill:{height:'100%',backgroundColor:'#F5C341',borderRadius:99},
 journeySummary:{backgroundColor:'#101916',borderRadius:18,borderWidth:1,borderColor:'#29372F',paddingHorizontal:13,paddingVertical:10},journeySummaryHeading:{flexDirection:'row',alignItems:'center',gap:7,paddingBottom:8,borderBottomWidth:1,borderBottomColor:'#26332D'},journeySummaryTitle:{color:'#F5C341',fontSize:12,fontWeight:'900',letterSpacing:.8},journeyStatsRow:{flexDirection:'row',alignItems:'stretch',paddingTop:7},journeyStat:{flex:1,alignItems:'center',justifyContent:'center',paddingVertical:0},journeyStatValue:{color:'#F7F8F3',fontSize:23,fontWeight:'900'},journeyStatLabel:{color:'#AAB5B0',fontSize:11.5,fontWeight:'700',marginTop:1},statDivider:{width:1,backgroundColor:'#324038',marginVertical:4},
