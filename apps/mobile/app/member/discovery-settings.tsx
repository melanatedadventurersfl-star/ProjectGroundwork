  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.content}>
        ...
        <Text style={styles.intro}>Control whether other members can find your profile when they search Community by your name or username.</Text>
        ...
        <View style={styles.note}>
          ...
          <Text style={styles.noteText}>Turning search off does not remove existing connections or Circles. People you are already connected with will still remain connected.</Text>
        </View>
