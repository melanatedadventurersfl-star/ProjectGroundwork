...
const styles = StyleSheet.create({
  ...
  section: { gap: 11, marginTop: 8 }, sectionTitle: { color: '#FFF8E8', fontSize: 22, fontWeight: '900' }, tripCard: { backgroundColor: '#17211C', borderRadius: 18, borderWidth: 1, borderColor: '#29372F', overflow: 'hidden' }, image: { height: 130, justifyContent: 'flex-start', alignItems: 'flex-start', padding: 12 }, imageRadius: { borderTopLeftRadius: 18, borderTopRightRadius: 18 }, imageShade: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(5,10,7,0.28)' }, statusBadge: { color: '#FFF8E8', backgroundColor: 'rgba(15,23,19,0.78)', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, fontSize: 10, fontWeight: '900' },
