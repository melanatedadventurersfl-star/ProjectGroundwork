...
export default function MenuScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content}>
    ...
    {isFounder ? <View style={styles.section}>
      <Text style={styles.sectionTitle}>Creator</Text>
      <View style={[styles.card,styles.creatorCard]}>
        <Pressable style={styles.row} onPress={()=>openMenuRoute('/creator')}>
          <View style={styles.rowLead}><AppIcon name="badge" color="#F5C341" size={21} /><View><Text style={styles.rowTitle}>Creator Console</Text><Text style={styles.creatorMeta}>FOUNDER ACCESS</Text></View></View>
