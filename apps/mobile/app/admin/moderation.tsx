        ...
        {reports.map((report) => {
          ...
          return <View key={report.id} style={styles.card}>
            ...
            <View style={styles.snapshot}>
              ...
              {report.media_url && report.media_type === 'video' ? <Pressable style={styles.videoEvidenceButton} onPress={() => void Linking.openURL(report.media_url!)}><Text style={styles.videoEvidenceText}>Open video evidence</Text></Pressable> : null}
