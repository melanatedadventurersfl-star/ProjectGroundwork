...
export const CURATED_TRAIL_GUIDE_PHOTOS: Record<string, TrailGuidePhoto> = {
  ...
  'huguenot-memorial-park': { url: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/Shorebirds_at_Huguenot_Park.jpg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Shorebirds_at_Huguenot_Park.jpg', title: 'Huguenot Memorial Park', credit: 'The Bushranger / Wikimedia Commons', license: 'CC BY-SA 4.0' },
  'cary-state-forest': { url: 'https://ccmedia.fdacs.gov/var/ezdemo_site/storage/images/5/9/3/1/2741395-1-eng-US/forest-cary.jpg', sourceUrl: 'https://www.fdacs.gov/Forest-Wildfire/Our-Forests/State-Forests/Cary-State-Forest', title: 'Cary State Forest', credit: 'Florida Department of Agriculture and Consumer Services' },
  'anastasia-state-park': { url: 'https://upload.wikimedia.org/wikipedia/commons/b/bb/St_Aug_Anastasia_SP_bdwk03.jpg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:St_Aug_Anastasia_SP_bdwk03.jpg', title: 'Anastasia State Park', credit: 'Ebyabe / Wikimedia Commons', license: 'CC BY-SA 3.0' },
  'fort-clinch-state-park': { url: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Fort_Clinch_State_Park%2C_Florida%2C_US_%2825%29.jpg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Fort_Clinch_State_Park,_Florida,_US_(25).jpg', title: 'Fort Clinch State Park', credit: 'Wikimedia Commons' },
  'princess-place-preserve': { url: 'https://upload.wikimedia.org/wikipedia/commons/b/b5/Princess_Place_Preserve.jpg', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Princess_Place_Preserve.jpg', title: 'Princess Place Preserve', credit: 'Mwanner / Wikimedia Commons', license: 'CC BY-SA 3.0' },
  'faver-dykes-state-park': { url: 'https://upload.wikimedia.org/wikipedia/commons/9/9b/FL_Faver-Dykes_SP_sign01.jpg', sourceUrl: 'https://commons.wikimedia.org/wiki/Category:Faver-Dykes_State_Park', title: 'Faver-Dykes State Park', credit: 'Ebyabe / Wikimedia Commons' },
