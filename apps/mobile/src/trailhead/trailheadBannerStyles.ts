...
export const styles = StyleSheet.create({
  ...
  trailblazerHeatLayer: { position: 'absolute', left: 0, right: 0, bottom: 42, height: 72, overflow: 'hidden' },
  trailblazerHeatBand: { position: 'absolute', left: -20, right: -20, height: 18, borderRadius: 999, backgroundColor: 'rgba(255,210,154,0.10)' },
  trailblazerDust: { position: 'absolute', width: 3, height: 3, borderRadius: 999, backgroundColor: 'rgba(255,219,174,0.58)' },
