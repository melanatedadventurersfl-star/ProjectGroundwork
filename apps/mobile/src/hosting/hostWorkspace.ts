...
export const HOST_WORKSPACE_ITEMS: HostWorkspaceItem[] = [
  ...
  { key: 'connections', title: 'Connections & Apps', subtitle: 'Public experience, social, ticketing, email and future distribution apps', route: '/host/connections', icon: 'connections', accent: '#77B9A6', group: 'BUSINESS' },
