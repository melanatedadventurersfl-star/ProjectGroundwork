...
const stamps: Record<LegacyStampCode, StampDefinition> = {
  ...
  'legacy-event-2025-wet-wild': { year: 2025, title: ['GREAT MELANATED', 'WET & WILD', 'ADVENTURE'], date: 'JUL 18', location: 'ORLANDO / KISSIMMEE, FL', ink: '#0D6676', accent: '#F0B554', paper: '#E2D7B7', motif: 'waterpark' },
...
function Scene({ motif, ink, accent }: Pick<StampDefinition, 'motif' | 'ink' | 'accent'>) {
  ...
  if (motif === 'youth') return <G>{mountains}<Circle cx="95" cy="78" r="15" fill={accent} opacity={0.8}/><G fill={ink}><Circle cx="58" cy="124" r="9"/><Circle cx="95" cy="116" r="10"/><Circle cx="132" cy="124" r="9"/></G><Path d="M45 154 Q58 133 71 154 M80 154 Q95 128 110 154 M119 154 Q132 133 145 154" stroke={ink} strokeWidth={8} fill="none"/></G>;
