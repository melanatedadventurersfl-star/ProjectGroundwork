...
export const MANAGEMENT_SECTIONS: ManagementSection[] = [
  { key: 'work', title: 'My Work', subtitle: 'Tasks, planning, assignments and deadlines across the organization', icon: 'tasks', accent: '#A990ED', liveRoute: '/host/work', bullets: ['Quick add and imported task lists', 'Assignments, due dates and blocked work', 'Timeline, scheduling and AI task suggestions'] },
  ...
  { key: 'calendar', title: 'Event Calendar', subtitle: 'Upcoming event dates in one clean calendar', icon: 'calendar', accent: '#75AEE8', liveRoute: '/host/calendar', bullets: ['Month, week and agenda views', 'Multi-day event ranges', 'Direct links to event workspaces'] },
