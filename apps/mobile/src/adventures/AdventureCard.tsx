...
const styles = StyleSheet.create({
  ...
  image: { height: 225, justifyContent: 'space-between', backgroundColor: '#293B31' }, imageRadius: { borderTopLeftRadius: 20, borderTopRightRadius: 20 }, shade: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(8,13,10,0.34)' },
